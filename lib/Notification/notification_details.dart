...
class NotificationDetail extends StatefulWidget {
  int index = 0;
  NotificationDetail({super.key, required this.index});
          ...
          children: [
            ...
            Expanded(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text(notifications[widget.index]["title"], style: GoogleFonts.poppins(
                      fontWeight: FontWeight.bold,
                      fontSize: 13.sp
                  ),),
                  Text(notifications[widget.index]["message"], style: GoogleFonts.poppins(
                      fontSize: 11.sp,
